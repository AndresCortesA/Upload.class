...
class Upload {
    ...
    /**
    * Raw value of the maximum file size allowed for uploads
    * CHANGE
    * This variable holds the raw value as retrieved from the PHP configuration (php.ini) for the maximum
    * file size allowed for uploads. It is used for further processing and conversion.
    *
    * @access public
    * @var string
    */
